# Code from https://github.com/wjNam/Relative_Attributing_Propagation/tree/master
...
class BlurPoolConv2d(torch.nn.Module):
    def __init__(self, conv):
        ...
        self.conv = conv
        self.register_buffer('blur_filter', blurconv)
    def forward(self, x):
        blurred = self.blur_filter(x)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False, denis_resnet=False):
